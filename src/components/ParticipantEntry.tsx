  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 py-8 sm:py-12">
      ...
      <div className="text-center mb-8 flex flex-col items-center">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 text-xs font-mono font-medium uppercase tracking-widest mb-4">
      ...
      {hasActiveSession && onResumeQuiz && (
        <div className="mb-6 p-4 sm:p-5 rounded-xl bg-amber-500/10 border border-amber-500/40 text-amber-200">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <button
              ...
              className="w-full sm:w-auto px-5 py-2.5 rounded-lg bg-amber-500 hover:bg-amber-400 text-slate-950 font-mono text-xs font-bold uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-lg shadow-amber-500/20 cursor-pointer"
            >
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 sm:p-8 shadow-2xl relative overflow-hidden">
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              <input
                ...
                autoFocus
                className="w-full px-4 py-3.5 rounded-xl bg-slate-950 border border-slate-700 text-slate-100 placeholder-slate-500 focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-500/20 font-sans text-base transition-all"
              />
            </div>
            {error && (
              <p className="mt-1 text-xs text-rose-400 flex items-center gap-1.5 font-mono">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="p-4 rounded-xl bg-slate-950 border border-rose-500/30 flex flex-col gap-1.5">
          ...
          {/* Security Notice */}
          <div className="p-4 rounded-xl bg-cyan-950/40 border border-cyan-500/30 text-xs text-cyan-300 leading-relaxed font-mono">
          ...
          <button
            id="start-quiz-btn"
            type="submit"
            className="w-full py-4 px-6 rounded-xl bg-cyan-400 hover:bg-cyan-300 active:bg-cyan-500 text-slate-950 font-mono font-extrabold text-sm sm:text-base tracking-wider uppercase transition-all duration-150 flex items-center justify-center gap-2 shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 cursor-pointer"
          >
